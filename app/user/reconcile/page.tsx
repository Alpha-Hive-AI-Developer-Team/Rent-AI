      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-2">
        ...
        <div className="bg-[#0B0B0B] rounded-2xl border border-[#1a1a1a] p-4">
          ...
          <div className="mt-3 space-y-3">
            {[
              { name: "Tom Walker", due: "2025-10-01", amt: "£950" },
              { name: "Amira K.", due: "2025-10-01", amt: "£1450" },
            ].map((r, i) => (
              <div
                key={i}
                className="bg-black border border-gray-800 rounded-lg p-3 flex items-center justify-between gap-3"
              >
                <div>
        ...
        <div className="bg-[#0B0B0B] rounded-2xl border border-[#1a1a1a] p-4">
          ...
          <div className="mt-3 space-y-3">
            {[
              {
                title: "FPS WALKER TOM RENT 22 NORTH",
                tx: "TX-82",
                party: "Tom Walker",
                amt: "£950",
                score: "71%",
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-2">
                  <button className="bg-black border border-gray-800 text-emerald-400 px-3 py-1 rounded-full text-sm">
                    Accept + Learn
                  </button>
                  <button className="bg-black border border-gray-800 text-gray-300 px-3 py-1 rounded-full text-sm">
                    Reject
                  </button>
                </div>
              </div>
        ...
        <div className="bg-[#0B0B0B] rounded-2xl border border-[#1a1a1a] p-4">
          ...
          <div className="mt-3 space-y-3">
            {[
              {
                title: "FPI JACK LEAH 119AV RENT",
                date: "2025-10-01",
                amount: "£1200",
              },
              {
